...
train_dir=r'../input/amur-tiger-reidentification/Amur Tigers/train'
test_dir=r'../input/amur-tiger-reidentification/Amur Tigers/test'
train_csvpath=r'../input/amur-tiger-reidentification/Amur Tigers/reid_list_train.csv'
test_csvpath=r'../input/amur-tiger-reidentification/Amur Tigers/reid_list_test.csv'
...
# read csv file back in to make sure it is correct
